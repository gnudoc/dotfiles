...
(custom-set-variables
 ...
 '(package-selected-packages
   '(emms sudo-edit vterm pdf-tools dired-hide-dotfiles all-the-icons-dired rainbow-delimiters forge magit counsel-projectile projectile company-box company visual-fill-column org-bullets helpful counsel ivy-rich ivy which-key doom-modeline nerd-icons all-the-icons doom-themes)))
(custom-set-faces
